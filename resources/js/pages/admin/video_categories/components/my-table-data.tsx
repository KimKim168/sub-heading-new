    ...
    return (
        <>
            <ScrollArea className="w-full rounded-md border">
                <MyImageGallery
                    imagePath="/assets/images/video_categories/"
                            ...
                            <TableRow key={item.id}>
                                ...
                                <TableCell>
                                    <span className="flex h-full items-center justify-start">
                                        ...
                                        {hasPermission('post delete') && <DeleteButton deletePath="/admin/video_categories/" id={item.id} />}
                                ...
                                <TableCell>
                                    {item.image ? (
                                        ...
                                        >
                                            <img
                                                src={`/assets/images/video_categories/thumb/` + item.image}
                                                width={100}
                                                height={100}
                                                alt=""
                                ...
                                <TableCell>
                                    ...
                                    {item.banner ? (
                                        ...
                                        >
                                            <img
                                                src={`/assets/images/video_categories/thumb/` + item.banner}
                                                width={100}
                                                height={100}
                                                alt=""
                                                className="size-10 object-contain transition-all duration-300 hover:scale-150"
                                ...
                                <TableCell>
                                    {hasPermission('post update') ? (
                                        <MyUpdateStatusButton
                                            id={item.id}
                                            pathName="/admin/video_categories"
